...
-- @example for subscript in node:subscripts() do ...
...
-- @param[opt] filter `function(node, node_top_subscript_name, value, recurse, depth)` or nil
--
...
-- @example for subnode,value[,subscript] in pairs(node) do ...
